      ...
      app.run_ci do |test_run|
        ...
        expect(clean_output(test_run.output)).to eq(<<~OUTPUT)
          ...
          -----> Running: sbt update
                 ...
                 [info] loading global plugins from /tmp/cache3160231006/sbt_global/plugins
                 [info] compiling 1 Scala source to /tmp/cache3160231006/sbt_global/plugins/target/scala-2.12/sbt-1.0/classes ...
