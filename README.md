Heroku Buildpack for Scala [![Build Status](https://travis-ci.com/heroku/heroku-buildpack-scala.svg?branch=main)](https://travis-ci.com/heroku/heroku-buildpack-scala)
=========================
