...
object Heroku extends Plugin {
  override def settings = Seq(
    externalResolvers <<= resolvers map { appResolvers =>
      ...
      Seq(Resolver.url("heroku-sbt-typesafe") artifacts "http://maven-s3pository.herokuapp.com/typesafe-releases-ivy/[organization]/[module]/[revision]/[type]s/[artifact](-[classifier]).[ext]",
