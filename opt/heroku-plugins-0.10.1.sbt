resolvers ++= Seq(Resolver.url("heroku-sbt-typesafe") artifacts "http://maven-s3pository.herokuapp.com/typesafe-ivy/[organization]/[module]/[revision]/[type]s/[artifact](-[classifier]).[ext]",
